...
public class Conexion {
    ...
    protected CallableStatement obj_Procedimiento;//Utilizar los procedure""Procedimientos almacenados
    protected Statement stmt;//Statement"Sentencias de SQL" Hacer sentencias SQL
